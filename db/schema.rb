...
ActiveRecord::Schema.define(version: 20_200_921_075_137) do
  ...
  create_table 'cash_accounts', force: :cascade do |t|
    ...
    t.index %w[data_type data_id], name: 'index_cash_accounts_on_data_type_and_data_id'
  end
  ...
  create_table 'properties', force: :cascade do |t|
    ...
    t.index %w[data_type data_id], name: 'index_properties_on_data_type_and_data_id'
  end
  ...
  create_table 'users', force: :cascade do |t|
    ...
    t.index %w[role_type role_id], name: 'index_users_on_role_type_and_role_id'
  end
end
